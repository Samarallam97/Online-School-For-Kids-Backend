...
{
    // Must match the emails seeded by ContentCreatorSeeder. Run
    // ContentCreatorSeeder.SeedAsync BEFORE this seeder in startup.
    private const string Amira = "amira.fouad@maman.com";
    private const string Daniel = "daniel.reyes@maman.com";
    private const string Noor = "noor.abdallah@maman.com";
    private const string Olivia = "olivia.bennett@maman.com";
    private const string Youssef = "youssef.karam@maman.com";
    ...
    public static async Task SeedAsync(IHost app)
    {
        ...
        try
        {
            ...
            // ── Resolve real content-creator IDs by email ──────────────────
            var creatorEmails = new[] { Amira, Daniel, Noor, Olivia, Youssef };
            var creatorIds = new Dictionary<string, string>();

            foreach (var email in creatorEmails)
            {
                var user = await userRepo.GetByEmailAsync(email, CancellationToken.None);
                if (user == null)
                {
                    logger.LogWarning(
                        "Content creator {Email} not found — run ContentCreatorSeeder before CourseSeeder. Skipping course seeding.",
                        email);
                    return;
                }
                creatorIds[email] = user.Id;
            }
            ...
            var featured = new Course
            {
                ...
                InstructorId = creatorIds[Daniel],
            ...
            courses.Add(WithSections(new Course { Id = c1Id, Title = "Foundations of Early Childhood Education", Description = "A comprehensive introduction to teaching children ages 3–6, covering play-based learning, classroom management, and developmental milestones.", InstructorId = creatorIds[Amira], CategoryId = categoryMap["Early Childhood Education"], AgeGroup = AgeGroup.ForEducators, Price = 49.99m, DiscountPrice = 29.99m, Rating = 4.8m, TotalStudents = 12400, DurationHours = 22, ThumbnailUrl = "https://images.unsplash.com/photo-1503676260728-1c00da094a0b?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c3Id, Title = "Sensory Play & Learning Activities", Description = "Discover how sensory play builds neural pathways in young children. Includes 50+ activity ideas for toddlers and preschoolers.", InstructorId = creatorIds[Noor], CategoryId = categoryMap["Early Childhood Education"], AgeGroup = AgeGroup.Toddlers, Price = 34.99m, DiscountPrice = null, Rating = 4.7m, TotalStudents = 5300, DurationHours = 10, ThumbnailUrl = "https://images.unsplash.com/photo-1596464716127-f2a82984de30?w=600", Language = "English", IsPublished = true, IsFeatured = false, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c4Id, Title = "Teaching Mathematics to Primary School Children", Description = "Practical strategies and manipulative-based techniques to make maths engaging and accessible for children ages 6–12.", InstructorId = creatorIds[Amira], CategoryId = categoryMap["Primary Education"], AgeGroup = AgeGroup.EarlyPrimary, Price = 54.99m, DiscountPrice = 34.99m, Rating = 4.8m, TotalStudents = 14200, DurationHours = 24, ThumbnailUrl = "https://images.unsplash.com/photo-1509228468518-180dd4864904?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c8Id, Title = "Teaching Coding to Kids with Scratch", Description = "A beginner-friendly course teaching children ages 7–14 to code using Scratch.", InstructorId = creatorIds[Daniel], CategoryId = categoryMap["STEM for Kids"], AgeGroup = AgeGroup.EarlyPrimary, Price = 44.99m, DiscountPrice = 24.99m, Rating = 4.9m, TotalStudents = 31500, DurationHours = 16, ThumbnailUrl = "https://images.unsplash.com/photo-1580894742597-87bc8789db3d?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c9Id, Title = "Robotics for Kids: LEGO Mindstorms", Description = "Guide children through building and programming LEGO Mindstorms robots.", InstructorId = creatorIds[Daniel], CategoryId = categoryMap["STEM for Kids"], AgeGroup = AgeGroup.LatePrimary, Price = 69.99m, DiscountPrice = 49.99m, Rating = 4.8m, TotalStudents = 8900, DurationHours = 22, ThumbnailUrl = "https://images.unsplash.com/photo-1561144257-e32e8506646d?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c10Id, Title = "Drawing & Painting for Children", Description = "Step-by-step drawing and painting lessons for children ages 5–12.", InstructorId = creatorIds[Youssef], CategoryId = categoryMap["Arts & Creativity"], AgeGroup = AgeGroup.EarlyPrimary, Price = 34.99m, DiscountPrice = 19.99m, Rating = 4.8m, TotalStudents = 24600, DurationHours = 14, ThumbnailUrl = "https://images.unsplash.com/photo-1452860606245-08befc0ff44b?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c12Id, Title = "Teaching Reading: Phonics & Phonemic Awareness", Description = "A systematic phonics programme to help children ages 4–7 crack the reading code.", InstructorId = creatorIds[Olivia], CategoryId = categoryMap["Language & Literacy"], AgeGroup = AgeGroup.Preschool, Price = 44.99m, DiscountPrice = 29.99m, Rating = 4.9m, TotalStudents = 27800, DurationHours = 18, ThumbnailUrl = "https://images.unsplash.com/photo-1456513080510-7bf3a84b82f8?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c13Id, Title = "Arabic Language for Children: Beginner", Description = "A fun, story-based Arabic course for children ages 5–10, teaching letters and basic conversation.", InstructorId = creatorIds[Olivia], CategoryId = categoryMap["Language & Literacy"], AgeGroup = AgeGroup.EarlyPrimary, Price = 49.99m, DiscountPrice = 34.99m, Rating = 4.8m, TotalStudents = 14500, DurationHours = 20, ThumbnailUrl = "https://images.unsplash.com/photo-1546410531-bb4caa6b424d?w=600", Language = "Arabic", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c15Id, Title = "Teaching Empathy & Kindness in Early Childhood", Description = "Practical lessons to cultivate empathy and pro-social behaviour in young children ages 3–8.", InstructorId = creatorIds[Amira], CategoryId = categoryMap["Social & Emotional Learning"], AgeGroup = AgeGroup.ForEducators, Price = 39.99m, DiscountPrice = 24.99m, Rating = 4.8m, TotalStudents = 13500, DurationHours = 12, ThumbnailUrl = "https://images.unsplash.com/photo-1529156069898-49953e39b3ac?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c17Id, Title = "Positive Discipline: From Toddler to Teen", Description = "A whole-family approach to discipline that builds cooperation and mutual respect.", InstructorId = creatorIds[Olivia], CategoryId = categoryMap["Parenting & Family"], AgeGroup = AgeGroup.ForParents, Price = 54.99m, DiscountPrice = 34.99m, Rating = 4.9m, TotalStudents = 33200, DurationHours = 20, ThumbnailUrl = "https://images.unsplash.com/photo-1476703993599-0035a21b17a9?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            courses.Add(WithSections(new Course { Id = c18Id, Title = "Newborn Care: The First 12 Weeks", Description = "Everything new parents need to know about feeding, sleep, and bonding in the early weeks.", InstructorId = creatorIds[Noor], CategoryId = categoryMap["Parenting & Family"], AgeGroup = AgeGroup.ForParents, Price = 39.99m, DiscountPrice = 24.99m, Rating = 4.9m, TotalStudents = 28700, DurationHours = 14, ThumbnailUrl = "https://images.unsplash.com/photo-1555252333-9f8e92e65df9?w=600", Language = "English", IsPublished = true, IsFeatured = true, IsVisible = true }, new List<Section>
            {
            ...
            logger.LogInformation("Seeded {Count} courses across {CatCount} categories, assigned to {CreatorCount} creators.", courses.Count, categoryMap.Count, creatorIds.Count);
        }
        catch (Exception ex)
        {
